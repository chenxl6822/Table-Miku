...
FALLBACK_KNOWLEDGE: dict[str, dict[str, Any]] = {
    ...
    "软件工程": {
        "overview": "软件工程是用工程化方法开发、运行和维护软件系统的学科，涵盖需求分析、设计、编码、测试、部署和维护全生命周期。核心目标是在成本、时间和质量之间取得平衡，通过系统化、规范化、可量化的方法管理软件开发过程。",
        "sections": [
    ...
    "算法设计与分析": {
        "overview": "算法设计与分析研究如何设计高效算法并分析其时间与空间复杂度。核心内容包括分治法、动态规划、贪心算法、图算法、NP完全性理论和近似算法，是计算机科学的核心基础课程之一。",
        "sections": [
    ...
    "计算机安全": {
        "overview": "计算机安全研究保护信息系统免受未授权访问、使用、泄露、破坏、修改或销毁的方法。核心领域包括密码学、网络安全、系统安全、应用安全和安全管理，是保障数字资产安全的关键学科。",
        "sections": [
    ...
    "分布式系统": {
        "overview": "分布式系统由多台独立计算机通过网络协作，对外表现为一个统一系统。核心挑战包括一致性、可用性、分区容错、共识算法和分布式事务，是现代大规模互联网服务的基础架构模式。",
        "sections": [
